...
| HiBerCommonInstaller | [集成指南](../../docs/HiBerCommonInstaller-integration.md) | [使用文档](../../docs/NSUM-Installer.md) | 通用安装器框架（submodule；NSUM 安装器 = 单文件 NSUM_Installer_<版本>.exe，无运行时 DLL） |
